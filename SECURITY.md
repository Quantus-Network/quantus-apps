...
1. **GitHub private security advisory (preferred).**
   [Report a vulnerability](https://github.com/quantus-network/quantus-apps/security/advisories/new).
...
**In scope:** the Quantus mobile wallet, cold-wallet app, miner app, and Dart SDK in this repository — anything that could lead to exposure of keys or seeds, loss of funds, or a failed or incorrect transaction.
