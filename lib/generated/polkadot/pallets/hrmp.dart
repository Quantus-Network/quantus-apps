...
class Txs {
  ...
  _i11.Hrmp hrmpAcceptOpenChannel({required _i5.Id sender}) {
    return _i11.Hrmp(_i12.HrmpAcceptOpenChannel(sender: sender));
  }
  ...
  _i11.Hrmp hrmpCloseChannel({required _i2.HrmpChannelId channelId}) {
    return _i11.Hrmp(_i12.HrmpCloseChannel(channelId: channelId));
  }
  ...
  ///
  /// Origin must be the `ChannelManager`.
  _i11.Hrmp forceProcessHrmpOpen({required int channels}) {
    return _i11.Hrmp(_i12.ForceProcessHrmpOpen(channels: channels));
  }
  ...
  ///
  /// Origin must be the `ChannelManager`.
  _i11.Hrmp forceProcessHrmpClose({required int channels}) {
    return _i11.Hrmp(_i12.ForceProcessHrmpClose(channels: channels));
  }
  ...
  /// witness data.
  _i11.Hrmp hrmpCancelOpenRequest({
    required _i2.HrmpChannelId channelId,
    required int openRequests,
  }) {
    return _i11.Hrmp(_i12.HrmpCancelOpenRequest(
      channelId: channelId,
  ...
  ///
  /// Origin must be the `ChannelManager`.
  _i11.Hrmp forceOpenHrmpChannel({
    required _i5.Id sender,
    required _i5.Id recipient,
    required int maxCapacity,
    required int maxMessageSize,
  }) {
    return _i11.Hrmp(_i12.ForceOpenHrmpChannel(
      sender: sender,
      recipient: recipient,
  ...
  _i11.Hrmp establishSystemChannel({
    required _i5.Id sender,
    required _i5.Id recipient,
  }) {
    return _i11.Hrmp(_i12.EstablishSystemChannel(
      sender: sender,
      recipient: recipient,
    ));
  }
  ...
  _i11.Hrmp pokeChannelDeposits({
    required _i5.Id sender,
    required _i5.Id recipient,
  }) {
    return _i11.Hrmp(_i12.PokeChannelDeposits(
      sender: sender,
      recipient: recipient,
    ));
  }
  ...
  _i11.Hrmp establishChannelWithSystem({required _i5.Id targetSystemChain}) {
    return _i11.Hrmp(
        _i12.EstablishChannelWithSystem(targetSystemChain: targetSystemChain));
  }
}
