...
class Txs {
  ...
  _i7.Crowdloan create({
    ...
    return _i7.Crowdloan(_i9.Create(
      index: index,
      cap: cap,
  ...
  _i7.Crowdloan contribute({
    required BigInt index,
    required BigInt value,
    _i10.MultiSignature? signature,
  }) {
    return _i7.Crowdloan(_i9.Contribute(
      index: index,
      value: value,
      signature: signature,
    ));
  ...
  _i7.Crowdloan withdraw({
    required _i11.AccountId32 who,
    required BigInt index,
  }) {
    return _i7.Crowdloan(_i9.Withdraw(
      who: who,
      index: index,
    ));
  }
  ...
  ///
  /// Origin must be signed, but can come from anyone.
  _i7.Crowdloan refund({required BigInt index}) {
    return _i7.Crowdloan(_i9.Refund(index: index));
  }

  /// Remove a fund after the retirement period has ended and all funds have been returned.
  _i7.Crowdloan dissolve({required BigInt index}) {
    return _i7.Crowdloan(_i9.Dissolve(index: index));
  }
  ...
  _i7.Crowdloan addMemo({
    required _i2.Id index,
    required List<int> memo,
  }) {
    return _i7.Crowdloan(_i9.AddMemo(
      index: index,
      memo: memo,
    ));
  }
  ...
  _i7.Crowdloan poke({required _i2.Id index}) {
    return _i7.Crowdloan(_i9.Poke(index: index));
  }
  ...
  _i7.Crowdloan contributeAll({
    required BigInt index,
    _i10.MultiSignature? signature,
  }) {
    return _i7.Crowdloan(_i9.ContributeAll(
      index: index,
      signature: signature,
    ));
  }
