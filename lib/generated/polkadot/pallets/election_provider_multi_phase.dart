...
class Txs {
  ...
  _i12.ElectionProviderMultiPhase submitUnsigned({
    required _i13.RawSolution rawSolution,
    required _i6.SolutionOrSnapshotSize witness,
  }) {
    return _i12.ElectionProviderMultiPhase(_i14.SubmitUnsigned(
  ...
  _i12.ElectionProviderMultiPhase setMinimumUntrustedScore(
      {_i8.ElectionScore? maybeNextScore}) {
    return _i12.ElectionProviderMultiPhase(
        _i14.SetMinimumUntrustedScore(maybeNextScore: maybeNextScore));
  }
  ...
  _i12.ElectionProviderMultiPhase setEmergencyElectionResult(
      {required List<_i7.Tuple2<_i15.AccountId32, _i16.Support>> supports}) {
    return _i12.ElectionProviderMultiPhase(
        _i14.SetEmergencyElectionResult(supports: supports));
  }
  ...
  _i12.ElectionProviderMultiPhase submit(
      {required _i13.RawSolution rawSolution}) {
    return _i12.ElectionProviderMultiPhase(
        _i14.Submit(rawSolution: rawSolution));
  }
  ...
  _i12.ElectionProviderMultiPhase governanceFallback({
    int? maybeMaxVoters,
    int? maybeMaxTargets,
  }) {
    return _i12.ElectionProviderMultiPhase(_i14.GovernanceFallback(
