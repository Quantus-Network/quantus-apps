  ...
  group('NumberFormattingService', () {
    ...
    group('formatBalance', () {
      ...
      test('formats large balance', () {
        ...
        expect(service.formatBalance(balance, maxDecimals: 3), '1234567890.123');
        expect(service.formatBalance(balance, maxDecimals: 4), '1234567890.123');
      });
    ...
    group('parseAmount', () {
      ...
      test('parses decimal string with max decimals', () {
        expect(service.parseAmount('1.123456789012'), BigInt.parse('1123456789012'));
      });

      test('parses decimal string exceeding max decimals (truncates)', () {
        expect(service.parseAmount('1.123456789012999'), BigInt.parse('1123456789012'));
      });

      test('parses string starting with decimal point', () {
        expect(service.parseAmount('.5'), BigInt.parse('500000000000'));
      });
