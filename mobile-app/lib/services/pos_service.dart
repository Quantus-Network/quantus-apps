...
class PosService {
  ...
  PosPaymentRequest createPaymentRequest({required String accountId, required BigInt amountRaw}) {
    final refId = generateRefId();
    final wireAmount = _formattingService.formatWireAmount(amountRaw);
