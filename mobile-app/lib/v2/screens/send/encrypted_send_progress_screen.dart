...
class EncryptedSendProgressScreen extends ConsumerStatefulWidget {
  ...
  /// a plan whose amountRaw differs.
  final BigInt amount;
...
class _EncryptedSendProgressScreenState extends ConsumerState<EncryptedSendProgressScreen> {
      ...
      child: ScaffoldBase(
        ...
        mainContent: Column(
          ...
          children: [
            ...
            if (cancelled && send.submittedRecipientRaw > BigInt.zero) ...[
              const SizedBox(height: 24),
              _buildPartialCancelNotice(colors, text, l10n, send.submittedRecipientRaw),
            ],
          ],
        ),
  ...
  Widget _buildStatusHeader(AppColorsV2 colors, AppTextTheme text, AppLocalizations l10n) {
    ...
    final amountLabel = fmt.formatBalance(widget.plan.amountRaw, maxDecimals: 2, addSymbol: true);
