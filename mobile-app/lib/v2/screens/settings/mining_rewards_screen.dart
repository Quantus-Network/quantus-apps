...
class _WithRewards extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final testnets = [
      _TestnetEntry('Planck', null, data.planckBlocks),
      ...
      children: [
        SplitCard(
          topChild: _CardTopSection(
            ...
            totalBlocksColor: colors.textContent,
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Text('${entry.blocks}', style: text.amountInline.copyWith(color: colors.textContent)),
              const SizedBox(height: 4),
