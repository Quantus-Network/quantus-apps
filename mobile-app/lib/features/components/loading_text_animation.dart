      ...
      builder: (context, child) {
        return Row(
          ...
          children: List.generate(text.length, (index) {
            ...
            final opacity = Curves.easeInOut.transform(normalizedValue > 1.0 ? 2.0 - normalizedValue : normalizedValue);

            return Opacity(
              opacity: 0.3 + (0.7 * opacity),
              child: Text(text[index], style: context.themeText.mediumTitle),
            );
          }),
        );
      },
