...
void main() {
  ...
  group('MultisigProposalGraphql', () {
    ...
    test('openProposalsQuery uses multisigId variable and open statuses', () {
      ...
      expect(MultisigProposalGraphql.buildOpenProposalsVariables(multisigAddress), {
        'multisigId': multisigAddress,
        'limit': 1000,
        'offset': 0,
      });
      expect(MultisigProposalGraphql.buildOpenProposalsPageVariables(multisigAddress, limit: 20, offset: 40), {
        'multisigId': multisigAddress,
        'limit': 20,
        'offset': 40,
      });
