class AppConstants {
  ...
  static const List<String> rpcEndpoints = ['https://d17a-49-124-204-200.ngrok-free.app'];
  static const List<String> graphQlEndpoints = ['https://8e42-49-124-204-200.ngrok-free.app/v1/graphql'];
