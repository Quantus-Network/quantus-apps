...
import 'package:quantus_sdk/generated/bell/types/pallet_reversible_transfers/high_security_account_data.dart';
import 'package:quantus_sdk/generated/bell/types/pallet_reversible_transfers/pending_transfer.dart';
import 'package:quantus_sdk/generated/bell/types/primitive_types/h256.dart';
...
class ReversibleTransfersService {
  ...
  Future<Uint8List> scheduleReversibleTransfer({
    ...
    try {
      final quantusApi = Bell(_substrateService.provider!);
