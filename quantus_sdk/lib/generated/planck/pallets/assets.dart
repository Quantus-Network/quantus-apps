...
import '../types/quantus_runtime/runtime_call.dart' as _i10;
...
class Queries {
  ...
  final _i1.StorageMap<int, List<dynamic>> _reserves =
      const _i1.StorageMap<int, List<dynamic>>(
    prefix: 'Assets',
    storage: 'Reserves',
  ...
  _i8.Future<List<dynamic>> reserves(
    int key1, {
    _i1.BlockHash? at,
  }) async {
  ...
  /// Maps an asset to a list of its configured reserve information.
  _i8.Future<List<List<dynamic>>> multiReserves(
    List<int> keys, {
    _i1.BlockHash? at,
  }) async {
...
class Txs {
  ...
  _i10.Assets destroyAccounts({required BigInt id}) {
    return _i10.Assets(_i12.DestroyAccounts(id: id));
  }
  ...
  _i10.Assets destroyApprovals({required BigInt id}) {
    return _i10.Assets(_i12.DestroyApprovals(id: id));
  }
  ...
  _i10.Assets finishDestroy({required BigInt id}) {
    return _i10.Assets(_i12.FinishDestroy(id: id));
  }
  ...
  ///
  /// Weight: `O(1)`
  _i10.Assets freezeAsset({required BigInt id}) {
    return _i10.Assets(_i12.FreezeAsset(id: id));
  }
  ...
  ///
  /// Weight: `O(1)`
  _i10.Assets thawAsset({required BigInt id}) {
    return _i10.Assets(_i12.ThawAsset(id: id));
  }
  ...
  ///
  /// Weight: `O(1)`
  _i10.Assets clearMetadata({required BigInt id}) {
    return _i10.Assets(_i12.ClearMetadata(id: id));
  }
  ...
  ///
  /// Weight: `O(1)`
  _i10.Assets forceClearMetadata({required BigInt id}) {
    return _i10.Assets(_i12.ForceClearMetadata(id: id));
  }
  ...
  ///
  /// Weight: `O(1)`
  _i10.Assets forceCancelApproval({
    required BigInt id,
    required _i11.MultiAddress owner,
    required _i11.MultiAddress delegate,
  }) {
  ...
  _i10.Assets touch({required BigInt id}) {
    return _i10.Assets(_i12.Touch(id: id));
  }
  ...
  ///
  /// Emits `AssetMinBalanceChanged` event when successful.
  _i10.Assets setReserves({
    required BigInt id,
    required List<dynamic> reserves,
  }) {
    return _i10.Assets(_i12.SetReserves(
      id: id,
      reserves: reserves,
    ));
  }
...
class Constants {
  ...
  final BigInt assetDeposit = BigInt.from(1000000000);

  /// The amount of funds that must be reserved for a non-provider asset account to be
  /// maintained.
  final BigInt assetAccountDeposit = BigInt.from(1000000000);

  /// The basic amount of funds that must be reserved when adding metadata to your asset.
  final BigInt metadataDepositBase = BigInt.from(1000000000);

  /// The additional funds that must be reserved for the number of bytes you store in your
  /// metadata.
  final BigInt metadataDepositPerByte = BigInt.from(1000000000);
