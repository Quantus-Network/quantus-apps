...
class Queries {
  ...
  _i14.Future<_i3.AccountInfo> account(_i2.AccountId32 key1, {_i1.BlockHash? at}) async {
  ...
  _i14.Future<_i5.PerDispatchClass> blockWeight({_i1.BlockHash? at}) async {
    ...
    return _i5.PerDispatchClass(
      normal: _i13.Weight(refTime: BigInt.zero, proofSize: BigInt.zero),
      operational: _i13.Weight(refTime: BigInt.zero, proofSize: BigInt.zero),
      mandatory: _i13.Weight(refTime: BigInt.zero, proofSize: BigInt.zero),
    ); /* Default */
  }
  ...
  _i14.Future<_i6.H256> blockHash(int key1, {_i1.BlockHash? at}) async {
  ...
  _i14.Future<List<int>> extrinsicData(int key1, {_i1.BlockHash? at}) async {
  ...
  _i14.Future<List<_i9.Tuple2<int, int>>> eventTopics(_i6.H256 key1, {_i1.BlockHash? at}) async {
  ...
  _i14.Future<_i13.Weight> extrinsicWeightReclaimed({_i1.BlockHash? at}) async {
    ...
    return _i13.Weight(refTime: BigInt.zero, proofSize: BigInt.zero); /* Default */
  }

  /// The full account information for a particular account ID.
  _i14.Future<List<_i3.AccountInfo>> multiAccount(List<_i2.AccountId32> keys, {_i1.BlockHash? at}) async {
  ...
  /// Map of block numbers to block hashes.
  _i14.Future<List<_i6.H256>> multiBlockHash(List<int> keys, {_i1.BlockHash? at}) async {
  ...
  /// Extrinsics data for the current block (maps an extrinsic's index to its data).
  _i14.Future<List<List<int>>> multiExtrinsicData(List<int> keys, {_i1.BlockHash? at}) async {
  ...
  /// the `EventIndex` then in case if the topic has the same contents on the next block
  /// no notification will be triggered thus the event might be lost.
  _i14.Future<List<List<_i9.Tuple2<int, int>>>> multiEventTopics(List<_i6.H256> keys, {_i1.BlockHash? at}) async {
