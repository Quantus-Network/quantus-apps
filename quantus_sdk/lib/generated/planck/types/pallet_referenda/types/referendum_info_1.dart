...
import 'referendum_status_1.dart' as _i3;
...
class $ReferendumInfo {
  ...
  Approved approved(int value0, _i4.Deposit? value1, _i4.Deposit? value2) {
    return Approved(value0, value1, value2);
  }

  Rejected rejected(int value0, _i4.Deposit? value1, _i4.Deposit? value2) {
    return Rejected(value0, value1, value2);
  }

  Cancelled cancelled(int value0, _i4.Deposit? value1, _i4.Deposit? value2) {
    return Cancelled(value0, value1, value2);
  }

  TimedOut timedOut(int value0, _i4.Deposit? value1, _i4.Deposit? value2) {
    return TimedOut(value0, value1, value2);
  }
...
class $ReferendumInfoCodec with _i1.Codec<ReferendumInfo> {
  ...
  @override
  void encodeTo(ReferendumInfo value, _i1.Output output) {
    switch (value.runtimeType) {
      ...
      case Killed:
        ...
        break;
      default:
        throw Exception('ReferendumInfo: Unsupported "$value" of type "${value.runtimeType}"');
    }
  }
...
class Ongoing extends ReferendumInfo {
  ...
  void encodeTo(_i1.Output output) {
    ...
    _i3.ReferendumStatus.codec.encodeTo(value0, output);
  }

  @override
  bool operator ==(Object other) => identical(this, other) || other is Ongoing && other.value0 == value0;
...
class Approved extends ReferendumInfo {
  const Approved(this.value0, this.value1, this.value2);
  ...
  Map<String, List<dynamic>> toJson() => {
    'Approved': [value0, value1?.toJson(), value2?.toJson()],
  };

  int _sizeHint() {
    int size = 1;
    size = size + _i1.U32Codec.codec.sizeHint(value0);
    size = size + const _i1.OptionCodec<_i4.Deposit>(_i4.Deposit.codec).sizeHint(value1);
    size = size + const _i1.OptionCodec<_i4.Deposit>(_i4.Deposit.codec).sizeHint(value2);
    return size;
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    const _i1.OptionCodec<_i4.Deposit>(_i4.Deposit.codec).encodeTo(value1, output);
    const _i1.OptionCodec<_i4.Deposit>(_i4.Deposit.codec).encodeTo(value2, output);
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Approved && other.value0 == value0 && other.value1 == value1 && other.value2 == value2;
...
class Rejected extends ReferendumInfo {
  const Rejected(this.value0, this.value1, this.value2);
  ...
  @override
  Map<String, List<dynamic>> toJson() => {
    'Rejected': [value0, value1?.toJson(), value2?.toJson()],
  };
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Rejected && other.value0 == value0 && other.value1 == value1 && other.value2 == value2;
...
class Cancelled extends ReferendumInfo {
  const Cancelled(this.value0, this.value1, this.value2);
  ...
  @override
  Map<String, List<dynamic>> toJson() => {
    'Cancelled': [value0, value1?.toJson(), value2?.toJson()],
  };
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Cancelled && other.value0 == value0 && other.value1 == value1 && other.value2 == value2;
...
class TimedOut extends ReferendumInfo {
  const TimedOut(this.value0, this.value1, this.value2);
  ...
  @override
  Map<String, List<dynamic>> toJson() => {
    'TimedOut': [value0, value1?.toJson(), value2?.toJson()],
  };
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TimedOut && other.value0 == value0 && other.value1 == value1 && other.value2 == value2;
...
class Killed extends ReferendumInfo {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Killed && other.value0 == value0;
