...
class Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
  const Tuple11(
    this.value0,
    this.value1,
    this.value2,
...
class Tuple11Codec<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
    with _i1.Codec<Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> {
  const Tuple11Codec(
    this.codec0,
    this.codec1,
    this.codec2,
  ...
  @override
  void encodeTo(Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> tuple, _i1.Output output) {
  ...
  @override
  Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> decode(_i1.Input input) {
    return Tuple11(
      codec0.decode(input),
      codec1.decode(input),
      codec2.decode(input),
  ...
  @override
  int sizeHint(Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> tuple) {
    int size = 0;
