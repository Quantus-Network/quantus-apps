...
class Casting {
  const Casting({required this.votes, required this.delegations, required this.prior});
  ...
  Map<String, dynamic> toJson() => {
    'votes': votes.map((value) => [value.value0, value.value1.toJson()]).toList(),
  ...
  bool operator ==(Object other) =>
      ...
      other is Casting &&
          _i7.listsEqual(other.votes, votes) &&
          other.delegations == delegations &&
          other.prior == prior;

  @override
  int get hashCode => Object.hash(votes, delegations, prior);
}
...
class $CastingCodec with _i1.Codec<Casting> {
  ...
  @override
  void encodeTo(Casting obj, _i1.Output output) {
    const _i1.SequenceCodec<_i2.Tuple2<int, _i3.AccountVote>>(
      _i2.Tuple2Codec<int, _i3.AccountVote>(_i1.U32Codec.codec, _i3.AccountVote.codec),
    ).encodeTo(obj.votes, output);
