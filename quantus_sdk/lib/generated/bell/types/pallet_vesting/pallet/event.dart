...
class $Event {
  ...
  LaunchMomentSet launchMomentSet({required BigInt at}) {
    return LaunchMomentSet(at: at);
  }
}
...
class $EventCodec with _i1.Codec<Event> {
  ...
  Event decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 4:
        return LaunchMomentSet._decode(input);
      default:
  ...
  void encodeTo(Event value, _i1.Output output) {
    switch (value.runtimeType) {
      ...
      case ScheduleRetargeted:
        ...
        break;
      case LaunchMomentSet:
        (value as LaunchMomentSet).encodeTo(output);
        break;
      default:
  ...
  int sizeHint(Event value) {
    switch (value.runtimeType) {
      ...
      case LaunchMomentSet:
        return (value as LaunchMomentSet)._sizeHint();
      default:
        throw Exception('Event: Unsupported "$value" of type "${value.runtimeType}"');
    }
  }
...
class LaunchMomentSet extends Event {
  const LaunchMomentSet({required this.at});

  factory LaunchMomentSet._decode(_i1.Input input) {
    return LaunchMomentSet(at: _i1.U64Codec.codec.decode(input));
  }
  ...
  Map<String, Map<String, BigInt>> toJson() => {
    'LaunchMomentSet': {'at': at},
  };

  int _sizeHint() {
    int size = 1;
    size = size + _i1.U64Codec.codec.sizeHint(at);
    return size;
  }

  void encodeTo(_i1.Output output) {
    _i1.U8Codec.codec.encodeTo(4, output);
    _i1.U64Codec.codec.encodeTo(at, output);
  }

  @override
  bool operator ==(Object other) => identical(this, other) || other is LaunchMomentSet && other.at == at;
