...
class Tuple4Codec<T0, T1, T2, T3> with _i1.Codec<Tuple4<T0, T1, T2, T3>> {
  const Tuple4Codec(this.codec0, this.codec1, this.codec2, this.codec3);
  ...
  @override
  void encodeTo(Tuple4<T0, T1, T2, T3> tuple, _i1.Output output) {
  ...
  Tuple4<T0, T1, T2, T3> decode(_i1.Input input) {
    return Tuple4(codec0.decode(input), codec1.decode(input), codec2.decode(input), codec3.decode(input));
  }
