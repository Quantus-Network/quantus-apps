...
class Proposal {
  const Proposal({required this.proposer, required this.value, required this.beneficiary, required this.bond});
  ...
  bool operator ==(Object other) =>
      ...
      other is Proposal &&
          _i4.listsEqual(other.proposer, proposer) &&
          other.value == value &&
          _i4.listsEqual(other.beneficiary, beneficiary) &&
          other.bond == bond;

  @override
  int get hashCode => Object.hash(proposer, value, beneficiary, bond);
}
...
class $ProposalCodec with _i1.Codec<Proposal> {
  ...
  @override
  void encodeTo(Proposal obj, _i1.Output output) {
    const _i1.U8ArrayCodec(32).encodeTo(obj.proposer, output);
    _i1.U128Codec.codec.encodeTo(obj.value, output);
    const _i1.U8ArrayCodec(32).encodeTo(obj.beneficiary, output);
    _i1.U128Codec.codec.encodeTo(obj.bond, output);
  }
