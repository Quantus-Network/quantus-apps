...
import 'block_number_or_timestamp.dart' as _i3;
...
class $DispatchTime {
  ...
  After after(_i3.BlockNumberOrTimestamp value0) {
    return After(value0);
  }
}
...
class After extends DispatchTime {
  ...
  factory After._decode(_i1.Input input) {
    return After(_i3.BlockNumberOrTimestamp.codec.decode(input));
  }

  /// BlockNumberOrTimestamp<BlockNumber, Moment>
  final _i3.BlockNumberOrTimestamp value0;

  @override
  Map<String, Map<String, dynamic>> toJson() => {'After': value0.toJson()};

  int _sizeHint() {
    int size = 1;
    size = size + _i3.BlockNumberOrTimestamp.codec.sizeHint(value0);
    return size;
  }
