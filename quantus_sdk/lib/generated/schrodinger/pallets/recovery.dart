...
class Queries {
  ...
  final _i1.StorageDoubleMap<_i2.AccountId32, _i2.AccountId32, _i4.ActiveRecovery> _activeRecoveries =
      const _i1.StorageDoubleMap<_i2.AccountId32, _i2.AccountId32, _i4.ActiveRecovery>(
        prefix: 'Recovery',
  ...
  _i5.Future<_i3.RecoveryConfig?> recoverable(_i2.AccountId32 key1, {_i1.BlockHash? at}) async {
  ...
  _i5.Future<_i4.ActiveRecovery?> activeRecoveries(
    ...
    final hashedKey = _activeRecoveries.hashedKeyFor(key1, key2);
    final bytes = await __api.getStorage(hashedKey, at: at);
    if (bytes != null) {
  ...
  _i5.Future<_i2.AccountId32?> proxy(_i2.AccountId32 key1, {_i1.BlockHash? at}) async {
  ...
  /// The set of recoverable accounts and their recovery configuration.
  _i5.Future<List<_i3.RecoveryConfig?>> multiRecoverable(List<_i2.AccountId32> keys, {_i1.BlockHash? at}) async {
    final hashedKeys = keys.map((key) => _recoverable.hashedKeyFor(key)).toList();
    final bytes = await __api.queryStorageAt(hashedKeys, at: at);
    if (bytes.isNotEmpty) {
      return bytes.first.changes.map((v) => _recoverable.decodeValue(v.key)).toList();
    }
    return []; /* Nullable */
  }
  ...
  ///
  /// Map from the user who can access it to the recovered account.
  _i5.Future<List<_i2.AccountId32?>> multiProxy(List<_i2.AccountId32> keys, {_i1.BlockHash? at}) async {
  ...
  _i6.Uint8List activeRecoveriesKey(_i2.AccountId32 key1, _i2.AccountId32 key2) {
    final hashedKey = _activeRecoveries.hashedKeyFor(key1, key2);
    return hashedKey;
  }
...
class Txs {
  ...
  _i7.Recovery asRecovered({required _i8.MultiAddress account, required _i7.RuntimeCall call}) {
    return _i7.Recovery(_i9.AsRecovered(account: account, call: call));
  }
  ...
  _i7.Recovery setRecovered({required _i8.MultiAddress lost, required _i8.MultiAddress rescuer}) {
    return _i7.Recovery(_i9.SetRecovered(lost: lost, rescuer: rescuer));
  }
  ...
  _i7.Recovery createRecovery({
    ...
    return _i7.Recovery(_i9.CreateRecovery(friends: friends, threshold: threshold, delayPeriod: delayPeriod));
  }
  ...
  /// process.
  _i7.Recovery vouchRecovery({required _i8.MultiAddress lost, required _i8.MultiAddress rescuer}) {
    return _i7.Recovery(_i9.VouchRecovery(lost: lost, rescuer: rescuer));
  }
