...
class Txs {
  ...
  ///  in the first place.
  _i7.TreasuryPallet removeApproval({required BigInt proposalId}) {
    return _i7.TreasuryPallet(_i9.RemoveApproval(proposalId: proposalId));
  }
  ...
  _i7.TreasuryPallet payout({required int index}) {
    return _i7.TreasuryPallet(_i9.Payout(index: index));
  }
  ...
  _i7.TreasuryPallet checkStatus({required int index}) {
    return _i7.TreasuryPallet(_i9.CheckStatus(index: index));
  }
  ...
  _i7.TreasuryPallet voidSpend({required int index}) {
    return _i7.TreasuryPallet(_i9.VoidSpend(index: index));
  }
}
