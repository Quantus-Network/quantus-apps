...
class Txs {
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i8.Vesting vestOther({required _i10.MultiAddress target}) {
    return _i8.Vesting(_i9.VestOther(target: target));
  }
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i8.Vesting forceVestedTransfer({
...
class Constants {
  ...
  final BigInt minVestedTransfer = BigInt.from(1000000000000);
