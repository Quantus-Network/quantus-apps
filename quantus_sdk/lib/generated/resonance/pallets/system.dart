...
class Queries {
  ...
  final _i1.StorageMap<_i6.H256, List<_i9.Tuple2<int, int>>> _eventTopics =
      const _i1.StorageMap<_i6.H256, List<_i9.Tuple2<int, int>>>(
        ...
        valueCodec: _i4.SequenceCodec<_i9.Tuple2<int, int>>(
          _i9.Tuple2Codec<int, int>(_i4.U32Codec.codec, _i4.U32Codec.codec),
        ),
  ...
  _i13.Future<_i3.AccountInfo> account(_i2.AccountId32 key1, {_i1.BlockHash? at}) async {
  ...
  _i13.Future<_i5.PerDispatchClass> blockWeight({_i1.BlockHash? at}) async {
    ...
    return _i5.PerDispatchClass(
      normal: _i15.Weight(refTime: BigInt.zero, proofSize: BigInt.zero),
      operational: _i15.Weight(refTime: BigInt.zero, proofSize: BigInt.zero),
      mandatory: _i15.Weight(refTime: BigInt.zero, proofSize: BigInt.zero),
    ); /* Default */
  }
  ...
  _i13.Future<_i6.H256> blockHash(int key1, {_i1.BlockHash? at}) async {
  ...
  _i13.Future<List<int>> extrinsicData(int key1, {_i1.BlockHash? at}) async {
  ...
  _i13.Future<List<_i9.Tuple2<int, int>>> eventTopics(_i6.H256 key1, {_i1.BlockHash? at}) async {
  ...
  /// The full account information for a particular account ID.
  _i13.Future<List<_i3.AccountInfo>> multiAccount(List<_i2.AccountId32> keys, {_i1.BlockHash? at}) async {
    ...
    return (keys
            ...
            .toList()
        as List<_i3.AccountInfo>); /* Default */
  }

  /// Map of block numbers to block hashes.
  _i13.Future<List<_i6.H256>> multiBlockHash(List<int> keys, {_i1.BlockHash? at}) async {
    ...
    return (keys.map((key) => List<int>.filled(32, 0, growable: false)).toList() as List<_i6.H256>); /* Default */
  }

  /// Extrinsics data for the current block (maps an extrinsic's index to its data).
  _i13.Future<List<List<int>>> multiExtrinsicData(List<int> keys, {_i1.BlockHash? at}) async {
  ...
  /// the `EventIndex` then in case if the topic has the same contents on the next block
  /// no notification will be triggered thus the event might be lost.
  _i13.Future<List<List<_i9.Tuple2<int, int>>>> multiEventTopics(List<_i6.H256> keys, {_i1.BlockHash? at}) async {
...
class Txs {
  ...
  _i17.System killPrefix({required List<int> prefix, required int subkeys}) {
    return _i17.System(_i18.KillPrefix(prefix: prefix, subkeys: subkeys));
  }
...
class Constants {
  ...
  final _i19.BlockWeights blockWeights = _i19.BlockWeights(
    baseBlock: _i15.Weight(refTime: BigInt.from(431614000), proofSize: BigInt.zero),
    ...
    perClass: _i20.PerDispatchClass(
      normal: _i21.WeightsPerClass(
        baseExtrinsic: _i15.Weight(refTime: BigInt.from(108157000), proofSize: BigInt.zero),
        ...
        maxTotal: _i15.Weight(
          ...
          proofSize: BigInt.parse('13835058055282163711', radix: 10),
        ),
        reserved: _i15.Weight(refTime: BigInt.zero, proofSize: BigInt.zero),
      ),
      operational: _i21.WeightsPerClass(
        ...
        reserved: _i15.Weight(
          ...
          proofSize: BigInt.parse('4611686018427387904', radix: 10),
        ),
      ),
  ...
  final _i22.BlockLength blockLength = const _i22.BlockLength(
    max: _i23.PerDispatchClass(normal: 3932160, operational: 5242880, mandatory: 5242880),
  );
  ...
  final _i25.RuntimeVersion version = const _i25.RuntimeVersion(
    ...
    apis: [
      ...
      _i9.Tuple2<List<int>, int>(<int>[55, 227, 151, 252, 124, 145, 245, 228], 2),
      _i9.Tuple2<List<int>, int>(<int>[64, 254, 58, 212, 1, 248, 149, 154], 6),
      _i9.Tuple2<List<int>, int>(<int>[210, 188, 152, 151, 238, 208, 143, 21], 3),
