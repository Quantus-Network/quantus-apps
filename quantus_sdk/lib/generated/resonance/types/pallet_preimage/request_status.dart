...
class $RequestStatus {
  ...
  Requested requested({
    _i3.Tuple2<_i4.AccountId32, _i5.PreimageDeposit>? maybeTicket,
    required int count,
    int? maybeLen,
  }) {
    return Requested(
...
class Unrequested extends RequestStatus {
  ...
  factory Unrequested._decode(_i1.Input input) {
    return Unrequested(
      ticket: const _i3.Tuple2Codec<_i4.AccountId32, _i5.PreimageDeposit>(
  ...
  /// (AccountId, Ticket)
  final _i3.Tuple2<_i4.AccountId32, _i5.PreimageDeposit> ticket;
...
class Requested extends RequestStatus {
  ...
  final _i3.Tuple2<_i4.AccountId32, _i5.PreimageDeposit>? maybeTicket;
