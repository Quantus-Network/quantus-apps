...
class $Event {
  ...
  HighSecuritySet highSecuritySet({
    ...
    return HighSecuritySet(who: who, interceptor: interceptor, recoverer: recoverer, delay: delay);
  }
...
class HighSecuritySet extends Event {
  const HighSecuritySet({required this.who, required this.interceptor, required this.recoverer, required this.delay});
  ...
  bool operator ==(Object other) =>
      ...
      other is HighSecuritySet &&
          ...
          _i9.listsEqual(other.recoverer, recoverer) &&
          other.delay == delay;

  @override
  int get hashCode => Object.hash(who, interceptor, recoverer, delay);
}
...
class TransactionScheduled extends Event {
  ...
  @override
  int get hashCode => Object.hash(from, to, interceptor, amount, txId, executeAt);
}
