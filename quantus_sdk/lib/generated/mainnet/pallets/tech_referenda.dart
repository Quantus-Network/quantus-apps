...
class Constants {
  ...
  final BigInt submissionDeposit = BigInt.from(1000000000000);
  ...
  final int maxProposalSize = 4096;
  ...
  final List<_i5.Tuple2<int, _i14.TrackDetails>> tracks = [
    ...
    _i5.Tuple2<int, _i14.TrackDetails>(
      ...
      _i14.TrackDetails(
        ...
        minApproval: const _i15.LinearDecreasing(length: 1000000000, floor: 800000000, ceil: 800000000),
        minSupport: const _i15.LinearDecreasing(length: 1000000000, floor: 800000000, ceil: 800000000),
      ),
    ),
  ];
}
