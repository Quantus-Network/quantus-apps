...
import '../frame_support/traits/storage/disabled.dart' as _i3;
...
class AuthorizedAliasesEntry {
  ...
  /// Ticket
  final _i3.Disabled ticket;

  static const $AuthorizedAliasesEntryCodec codec =
      $AuthorizedAliasesEntryCodec();
...
class $AuthorizedAliasesEntryCodec with _i1.Codec<AuthorizedAliasesEntry> {
  ...
  void encodeTo(
    ...
    const _i1.SequenceCodec<_i2.OriginAliaser>(_i2.OriginAliaser.codec)
        .encodeTo(
      obj.aliasers,
      output,
    );
  ...
  AuthorizedAliasesEntry decode(_i1.Input input) {
    return AuthorizedAliasesEntry(
      aliasers:
          const _i1.SequenceCodec<_i2.OriginAliaser>(_i2.OriginAliaser.codec)
              .decode(input),
      ticket: _i1.NullCodec.codec.decode(input),
    );
  }
  ...
  int sizeHint(AuthorizedAliasesEntry obj) {
    ...
    size = size +
        const _i1.SequenceCodec<_i2.OriginAliaser>(_i2.OriginAliaser.codec)
            .sizeHint(obj.aliasers);
    size = size + const _i3.DisabledCodec().sizeHint(obj.ticket);
    return size;
  }
}
