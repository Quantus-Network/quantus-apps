...
import '../pallet_bags_list/pallet/event.dart' as _i25;
import '../pallet_balances/pallet/event.dart' as _i7;
import '../pallet_bounties/pallet/event.dart' as _i22;
import '../pallet_child_bounties/pallet/event.dart' as _i23;
import '../pallet_conviction_voting/pallet/event.dart' as _i14;
import '../pallet_delegated_staking/pallet/event.dart' as _i28;
import '../pallet_election_provider_multi_phase/pallet/event.dart' as _i24;
import '../pallet_fast_unstake/pallet/event.dart' as _i27;
...
import '../pallet_multisig/pallet/event.dart' as _i21;
import '../pallet_nomination_pools/pallet/event.dart' as _i26;
import '../pallet_offences/pallet/event.dart' as _i10;
import '../pallet_preimage/pallet/event.dart' as _i5;
import '../pallet_proxy/pallet/event.dart' as _i20;
...
import '../pallet_utility/pallet/event.dart' as _i19;
...
import '../polkadot_runtime_common/claims/pallet/event.dart' as _i17;
...
import '../polkadot_runtime_parachains/on_demand/pallet/event.dart' as _i33;
...
class $RuntimeEvent {
  ...
  Claims claims(_i17.Event value0) {
  ...
  Utility utility(_i19.Event value0) {
    return Utility(value0);
  }

  Proxy proxy(_i20.Event value0) {
    return Proxy(value0);
  }

  Multisig multisig(_i21.Event value0) {
    return Multisig(value0);
  }

  Bounties bounties(_i22.Event value0) {
    return Bounties(value0);
  }

  ChildBounties childBounties(_i23.Event value0) {
    return ChildBounties(value0);
  }

  ElectionProviderMultiPhase electionProviderMultiPhase(_i24.Event value0) {
    return ElectionProviderMultiPhase(value0);
  }

  VoterList voterList(_i25.Event value0) {
    return VoterList(value0);
  }

  NominationPools nominationPools(_i26.Event value0) {
    return NominationPools(value0);
  }

  FastUnstake fastUnstake(_i27.Event value0) {
    return FastUnstake(value0);
  }

  DelegatedStaking delegatedStaking(_i28.Event value0) {
...
class Claims extends RuntimeEvent {
  ...
  factory Claims._decode(_i1.Input input) {
    return Claims(_i17.Event.codec.decode(input));
  }
...
class Utility extends RuntimeEvent {
  ...
  factory Utility._decode(_i1.Input input) {
    return Utility(_i19.Event.codec.decode(input));
  }
...
class Proxy extends RuntimeEvent {
  ...
  factory Proxy._decode(_i1.Input input) {
    return Proxy(_i20.Event.codec.decode(input));
  }
...
class Multisig extends RuntimeEvent {
  ...
  factory Multisig._decode(_i1.Input input) {
    return Multisig(_i21.Event.codec.decode(input));
  }
...
class Bounties extends RuntimeEvent {
  ...
  factory Bounties._decode(_i1.Input input) {
    return Bounties(_i22.Event.codec.decode(input));
  }
...
class ChildBounties extends RuntimeEvent {
  ...
  factory ChildBounties._decode(_i1.Input input) {
    return ChildBounties(_i23.Event.codec.decode(input));
  }
...
class ElectionProviderMultiPhase extends RuntimeEvent {
  ...
  factory ElectionProviderMultiPhase._decode(_i1.Input input) {
    return ElectionProviderMultiPhase(_i24.Event.codec.decode(input));
  }
...
class VoterList extends RuntimeEvent {
  ...
  factory VoterList._decode(_i1.Input input) {
    return VoterList(_i25.Event.codec.decode(input));
  }
...
class NominationPools extends RuntimeEvent {
  ...
  factory NominationPools._decode(_i1.Input input) {
    return NominationPools(_i26.Event.codec.decode(input));
  }
...
class FastUnstake extends RuntimeEvent {
  ...
  factory FastUnstake._decode(_i1.Input input) {
    return FastUnstake(_i27.Event.codec.decode(input));
  }
...
class DelegatedStaking extends RuntimeEvent {
  const DelegatedStaking(this.value0);

  factory DelegatedStaking._decode(_i1.Input input) {
    return DelegatedStaking(_i28.Event.codec.decode(input));
  }

  /// pallet_delegated_staking::Event<Runtime>
  final _i28.Event value0;

  @override
  Map<String, Map<String, Map<String, dynamic>>> toJson() =>
      {'DelegatedStaking': value0.toJson()};
  ...
  bool operator ==(Object other) =>
      ...
      other is DelegatedStaking && other.value0 == value0;
...
class OnDemand extends RuntimeEvent {
  ...
  /// parachains_on_demand::Event<Runtime>
