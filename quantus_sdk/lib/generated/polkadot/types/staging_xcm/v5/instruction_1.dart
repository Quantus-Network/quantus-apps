...
class TransferReserveAsset extends Instruction {
  ...
  factory TransferReserveAsset._decode(_i1.Input input) {
    return TransferReserveAsset(
      ...
      xcm: const _i1.SequenceCodec<_i23.Instruction>(_i23.Instruction.codec)
          .decode(input),
    );
  }
...
class InitiateTransfer extends Instruction {
  ...
  factory InitiateTransfer._decode(_i1.Input input) {
    return InitiateTransfer(
      ...
      remoteFees: const _i1.OptionCodec<_i20.AssetTransferFilter>(
              _i20.AssetTransferFilter.codec)
          .decode(input),
      preserveOrigin: _i1.BoolCodec.codec.decode(input),
      assets: const _i1.SequenceCodec<_i20.AssetTransferFilter>(
              _i20.AssetTransferFilter.codec)
          .decode(input),
      remoteXcm:
          const _i1.SequenceCodec<_i23.Instruction>(_i23.Instruction.codec)
  ...
  int _sizeHint() {
    ...
    size = size +
        const _i1.OptionCodec<_i20.AssetTransferFilter>(
                _i20.AssetTransferFilter.codec)
            .sizeHint(remoteFees);
    size = size + _i1.BoolCodec.codec.sizeHint(preserveOrigin);
    size = size +
        const _i1.SequenceCodec<_i20.AssetTransferFilter>(
                _i20.AssetTransferFilter.codec)
            .sizeHint(assets);
...
class SetHints extends Instruction {
  ...
  factory SetHints._decode(_i1.Input input) {
    return SetHints(
        hints:
            const _i1.SequenceCodec<_i21.Hint>(_i21.Hint.codec).decode(input));
  }
  ...
  int _sizeHint() {
    int size = 1;
    size = size +
        const _i1.SequenceCodec<_i21.Hint>(_i21.Hint.codec).sizeHint(hints);
    return size;
  }
