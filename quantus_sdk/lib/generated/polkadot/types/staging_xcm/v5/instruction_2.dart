...
class TransferReserveAsset extends Instruction {
  ...
  factory TransferReserveAsset._decode(_i1.Input input) {
    return TransferReserveAsset(
      ...
      xcm: const _i1.SequenceCodec<_i24.Instruction>(_i24.Instruction.codec)
          .decode(input),
    );
  }
...
class Transact extends Instruction {
  ...
  factory Transact._decode(_i1.Input input) {
    return Transact(
      ...
      fallbackMaxWeight:
          const _i1.OptionCodec<_i5.Weight>(_i5.Weight.codec).decode(input),
  ...
  int _sizeHint() {
    ...
    size = size +
        const _i1.OptionCodec<_i5.Weight>(_i5.Weight.codec)
            .sizeHint(fallbackMaxWeight);
...
class SetErrorHandler extends Instruction {
  ...
  factory SetErrorHandler._decode(_i1.Input input) {
    return SetErrorHandler(
        const _i1.SequenceCodec<_i25.Instruction>(_i25.Instruction.codec)
            .decode(input));
  }
...
class InitiateTransfer extends Instruction {
  ...
  factory InitiateTransfer._decode(_i1.Input input) {
    return InitiateTransfer(
      ...
      remoteFees: const _i1.OptionCodec<_i21.AssetTransferFilter>(
              _i21.AssetTransferFilter.codec)
          .decode(input),
      preserveOrigin: _i1.BoolCodec.codec.decode(input),
      assets: const _i1.SequenceCodec<_i21.AssetTransferFilter>(
              _i21.AssetTransferFilter.codec)
          .decode(input),
      remoteXcm:
          const _i1.SequenceCodec<_i24.Instruction>(_i24.Instruction.codec)
              .decode(input),
    );
  }
  ...
  int _sizeHint() {
    ...
    size = size +
        const _i1.OptionCodec<_i21.AssetTransferFilter>(
                _i21.AssetTransferFilter.codec)
            .sizeHint(remoteFees);
    size = size + _i1.BoolCodec.codec.sizeHint(preserveOrigin);
    size = size +
        const _i1.SequenceCodec<_i21.AssetTransferFilter>(
                _i21.AssetTransferFilter.codec)
            .sizeHint(assets);
...
class ExecuteWithOrigin extends Instruction {
  ...
  factory ExecuteWithOrigin._decode(_i1.Input input) {
    return ExecuteWithOrigin(
      descendantOrigin:
          const _i1.OptionCodec<_i10.Junctions>(_i10.Junctions.codec)
              .decode(input),
      xcm: const _i1.SequenceCodec<_i25.Instruction>(_i25.Instruction.codec)
          .decode(input),
    );
  }
...
class SetHints extends Instruction {
  ...
  factory SetHints._decode(_i1.Input input) {
    return SetHints(
        hints:
            const _i1.SequenceCodec<_i22.Hint>(_i22.Hint.codec).decode(input));
  }
  ...
  @override
  Map<String, Map<String, List<Map<String, Map<String, Map<String, dynamic>>>>>>
      toJson() => {
  ...
  int _sizeHint() {
    int size = 1;
    size = size +
        const _i1.SequenceCodec<_i22.Hint>(_i22.Hint.codec).sizeHint(hints);
    return size;
  }
