...
import '../v8/slashing/disputes_time_slot.dart' as _i2;
import '../v8/validator_app/public.dart' as _i5;
import '../v8/validator_index.dart' as _i4;
import 'dispute_offence_kind.dart' as _i3;
...
class DisputeProof {
  ...
  /// DisputeOffenceKind
  final _i3.DisputeOffenceKind kind;
...
class $DisputeProofCodec with _i1.Codec<DisputeProof> {
  ...
  void encodeTo(
    ...
    _i3.DisputeOffenceKind.codec.encodeTo(
      obj.kind,
      output,
    );
  ...
  DisputeProof decode(_i1.Input input) {
    return DisputeProof(
      ...
      kind: _i3.DisputeOffenceKind.codec.decode(input),
  ...
  int sizeHint(DisputeProof obj) {
    ...
    size = size + _i3.DisputeOffenceKind.codec.sizeHint(obj.kind);
