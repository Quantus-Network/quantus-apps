...
import '../v8/validity_attestation.dart' as _i3;
import 'committed_candidate_receipt_v2.dart' as _i2;
...
class BackedCandidate {
  ...
  final _i2.CommittedCandidateReceiptV2 candidate;
...
class $BackedCandidateCodec with _i1.Codec<BackedCandidate> {
  ...
  void encodeTo(
    ...
    _i2.CommittedCandidateReceiptV2.codec.encodeTo(
      obj.candidate,
      output,
    );
  ...
  BackedCandidate decode(_i1.Input input) {
    return BackedCandidate(
      candidate: _i2.CommittedCandidateReceiptV2.codec.decode(input),
  ...
  int sizeHint(BackedCandidate obj) {
    int size = 0;
    size = size + _i2.CommittedCandidateReceiptV2.codec.sizeHint(obj.candidate);
    size = size +
        const _i1.SequenceCodec<_i3.ValidityAttestation>(
                _i3.ValidityAttestation.codec)
