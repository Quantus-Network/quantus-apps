...
class Txs {
  ...
  /// Total Complexity: O(1)
  /// </weight>
  _i9.Claims claimAttest({
    required _i6.AccountId32 dest,
    required _i10.EcdsaSignature ethereumSignature,
    required List<int> statement,
  }) {
    return _i9.Claims(_i11.ClaimAttest(
      dest: dest,
      ethereumSignature: ethereumSignature,
      statement: statement,
    ));
  ...
  /// Total Complexity: O(1)
  /// </weight>
  _i9.Claims attest({required List<int> statement}) {
    return _i9.Claims(_i11.Attest(statement: statement));
  }

  _i9.Claims moveClaim({
    required _i2.EthereumAddress old,
    required _i2.EthereumAddress new_,
    _i6.AccountId32? maybePreclaim,
  }) {
    return _i9.Claims(_i11.MoveClaim(
      old: old,
      new_: new_,
