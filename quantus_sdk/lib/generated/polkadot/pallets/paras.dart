...
import '../types/polkadot_parachain_primitives/primitives/validation_code_hash.dart'
    as _i2;
import '../types/polkadot_primitives/v8/pvf_check_statement.dart' as _i18;
import '../types/polkadot_primitives/v8/upgrade_go_ahead.dart' as _i10;
import '../types/polkadot_primitives/v8/upgrade_restriction.dart' as _i11;
import '../types/polkadot_primitives/v8/validator_app/signature.dart' as _i19;
...
class Txs {
  ...
  _i16.Paras forceSetCurrentCode({
    required _i5.Id para,
    required _i13.ValidationCode newCode,
  }) {
    return _i16.Paras(_i17.ForceSetCurrentCode(
      para: para,
      newCode: newCode,
    ));
  }
  ...
  _i16.Paras forceSetCurrentHead({
    required _i5.Id para,
    required _i7.HeadData newHead,
  }) {
    return _i16.Paras(_i17.ForceSetCurrentHead(
      para: para,
      newHead: newHead,
    ));
  }
  ...
  _i16.Paras forceScheduleCodeUpgrade({
    required _i5.Id para,
    required _i13.ValidationCode newCode,
    required int relayParentNumber,
  }) {
    return _i16.Paras(_i17.ForceScheduleCodeUpgrade(
      para: para,
      newCode: newCode,
  ...
  _i16.Paras forceNoteNewHead({
    required _i5.Id para,
    required _i7.HeadData newHead,
  }) {
    return _i16.Paras(_i17.ForceNoteNewHead(
      para: para,
      newHead: newHead,
    ));
  }
  ...
  /// initializer...
  _i16.Paras forceQueueAction({required _i5.Id para}) {
    return _i16.Paras(_i17.ForceQueueAction(para: para));
  }
  ...
  _i16.Paras addTrustedValidationCode(
      {required _i13.ValidationCode validationCode}) {
    return _i16.Paras(
        _i17.AddTrustedValidationCode(validationCode: validationCode));
  }
  ...
  /// dispatching.
  _i16.Paras pokeUnusedValidationCode(
      {required _i2.ValidationCodeHash validationCodeHash}) {
    return _i16.Paras(
        _i17.PokeUnusedValidationCode(validationCodeHash: validationCodeHash));
  }

  /// Includes a statement for a PVF pre-checking vote. Potentially, finalizes the vote and
  /// enacts the results if that was the last vote before achieving the supermajority.
  _i16.Paras includePvfCheckStatement({
    required _i18.PvfCheckStatement stmt,
    required _i19.Signature signature,
  }) {
    return _i16.Paras(_i17.IncludePvfCheckStatement(
      stmt: stmt,
      signature: signature,
    ));
  }
  ...
  /// Set the storage for the current parachain head data immediately.
  _i16.Paras forceSetMostRecentContext({
    required _i5.Id para,
    required int context,
  }) {
    return _i16.Paras(_i17.ForceSetMostRecentContext(
      para: para,
      context: context,
    ));
  }
