...
class Txs {
  ...
  _i12.NominationPools join({
    required BigInt amount,
    required int poolId,
  }) {
    return _i12.NominationPools(_i13.Join(
      amount: amount,
      poolId: poolId,
    ));
  }
  ...
  _i12.NominationPools bondExtra({required _i14.BondExtra extra}) {
    return _i12.NominationPools(_i13.BondExtra(extra: extra));
  }
  ...
  _i12.NominationPools poolWithdrawUnbonded({
    required int poolId,
    required int numSlashingSpans,
  }) {
    return _i12.NominationPools(_i13.PoolWithdrawUnbonded(
      poolId: poolId,
  ...
  _i12.NominationPools withdrawUnbonded({
    required _i15.MultiAddress memberAccount,
    required int numSlashingSpans,
  }) {
    return _i12.NominationPools(_i13.WithdrawUnbonded(
      memberAccount: memberAccount,
      numSlashingSpans: numSlashingSpans,
    ));
  }
  ...
  _i12.NominationPools createWithPoolId({
    required BigInt amount,
    required _i15.MultiAddress root,
    required _i15.MultiAddress nominator,
    required _i15.MultiAddress bouncer,
    ...
    return _i12.NominationPools(_i13.CreateWithPoolId(
      amount: amount,
      root: root,
      nominator: nominator,
      bouncer: bouncer,
  ...
  _i12.NominationPools nominate({
    ...
    return _i12.NominationPools(_i13.Nominate(
      poolId: poolId,
  ...
  _i12.NominationPools setState({
    required int poolId,
    required _i16.PoolState state,
  }) {
    return _i12.NominationPools(_i13.SetState(
      poolId: poolId,
      state: state,
    ));
  }
  ...
  /// pool.
  _i12.NominationPools setMetadata({
    required int poolId,
    required List<int> metadata,
  }) {
    return _i12.NominationPools(_i13.SetMetadata(
      poolId: poolId,
      metadata: metadata,
    ));
  }
  ...
  _i12.NominationPools setConfigs({
    ...
    return _i12.NominationPools(_i13.SetConfigs(
  ...
  _i12.NominationPools bondExtraOther({
    required _i15.MultiAddress member,
    required _i14.BondExtra extra,
  }) {
    return _i12.NominationPools(_i13.BondExtraOther(
      member: member,
      extra: extra,
    ));
  }
  ...
  _i12.NominationPools setClaimPermission(
      {required _i9.ClaimPermission permission}) {
    return _i12.NominationPools(
        _i13.SetClaimPermission(permission: permission));
  }
  ...
  _i12.NominationPools claimPayoutOther({required _i4.AccountId32 other}) {
    return _i12.NominationPools(_i13.ClaimPayoutOther(other: other));
  }
  ...
  _i12.NominationPools setCommission({
    required int poolId,
    _i21.Tuple2<_i3.Perbill, _i4.AccountId32>? newCommission,
  }) {
    return _i12.NominationPools(_i13.SetCommission(
      poolId: poolId,
  ...
  ///  commission.
  _i12.NominationPools setCommissionMax({
    required int poolId,
    required _i3.Perbill maxCommission,
  }) {
    return _i12.NominationPools(_i13.SetCommissionMax(
      poolId: poolId,
  ...
  _i12.NominationPools setCommissionChangeRate({
    required int poolId,
    required _i22.CommissionChangeRate changeRate,
  }) {
    return _i12.NominationPools(_i13.SetCommissionChangeRate(
      poolId: poolId,
  ...
  _i12.NominationPools adjustPoolDeposit({required int poolId}) {
    return _i12.NominationPools(_i13.AdjustPoolDeposit(poolId: poolId));
  }
  ...
  _i12.NominationPools setCommissionClaimPermission({
    required int poolId,
    _i23.CommissionClaimPermission? permission,
  }) {
    return _i12.NominationPools(_i13.SetCommissionClaimPermission(
      poolId: poolId,
  ...
  _i12.NominationPools applySlash({required _i15.MultiAddress memberAccount}) {
    return _i12.NominationPools(_i13.ApplySlash(memberAccount: memberAccount));
  }
  ...
  _i12.NominationPools migrateDelegation(
      {required _i15.MultiAddress memberAccount}) {
    return _i12.NominationPools(
        _i13.MigrateDelegation(memberAccount: memberAccount));
  }
  ...
  _i12.NominationPools migratePoolToDelegateStake({required int poolId}) {
    return _i12.NominationPools(
        _i13.MigratePoolToDelegateStake(poolId: poolId));
  }
}
