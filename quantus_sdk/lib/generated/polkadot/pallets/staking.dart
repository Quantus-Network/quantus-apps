...
class Txs {
  ...
  /// - O(1).
  _i23.Staking bondExtra({required BigInt maxAdditional}) {
    return _i23.Staking(_i24.BondExtra(maxAdditional: maxAdditional));
  }
  ...
  _i23.Staking unbond({required BigInt value}) {
    return _i23.Staking(_i24.Unbond(value: value));
  }
  ...
  _i23.Staking withdrawUnbonded({required int numSlashingSpans}) {
    return _i23.Staking(
        _i24.WithdrawUnbonded(numSlashingSpans: numSlashingSpans));
  }
  ...
  ///
  /// The dispatch origin for this call must be _Signed_ by the controller, not the stash.
  _i23.Staking validate({required _i7.ValidatorPrefs prefs}) {
    return _i23.Staking(_i24.Validate(prefs: prefs));
  }
  ...
  _i23.Staking nominate({required List<_i25.MultiAddress> targets}) {
    return _i23.Staking(_i24.Nominate(targets: targets));
  }
  ...
  /// - Writes are limited to the `origin` account key.
  /// ---------
  _i23.Staking setPayee({required _i6.RewardDestination payee}) {
    return _i23.Staking(_i24.SetPayee(payee: payee));
  }
  ...
  /// ## Complexity
  /// O(1)
  _i23.Staking setValidatorCount({required BigInt new_}) {
    return _i23.Staking(_i24.SetValidatorCount(new_: new_));
  }
  ...
  _i23.Staking increaseValidatorCount({required BigInt additional}) {
    return _i23.Staking(_i24.IncreaseValidatorCount(additional: additional));
  }
  ...
  /// ## Complexity
  /// Same as [`Self::set_validator_count`].
  _i23.Staking scaleValidatorCount({required _i15.Percent factor}) {
    return _i23.Staking(_i24.ScaleValidatorCount(factor: factor));
  }
  ...
  ///
  /// The dispatch origin must be Root.
  _i23.Staking setInvulnerables(
      {required List<_i3.AccountId32> invulnerables}) {
    return _i23.Staking(_i24.SetInvulnerables(invulnerables: invulnerables));
  }
  ...
  /// details.
  _i23.Staking forceUnstake({
    required _i3.AccountId32 stash,
    required int numSlashingSpans,
  }) {
    return _i23.Staking(_i24.ForceUnstake(
      stash: stash,
  ...
  _i23.Staking cancelDeferredSlash({
    required int era,
    required List<int> slashIndices,
  }) {
    return _i23.Staking(_i24.CancelDeferredSlash(
      era: era,
  ...
  _i23.Staking payoutStakers({
    required _i3.AccountId32 validatorStash,
    required int era,
  }) {
    return _i23.Staking(_i24.PayoutStakers(
  ...
  _i23.Staking rebond({required BigInt value}) {
    return _i23.Staking(_i24.Rebond(value: value));
  }
  ...
  /// - `num_slashing_spans`: Refer to comments on [`Call::withdraw_unbonded`] for more
  /// details.
  _i23.Staking reapStash({
    required _i3.AccountId32 stash,
    required int numSlashingSpans,
  }) {
    return _i23.Staking(_i24.ReapStash(
      stash: stash,
      numSlashingSpans: numSlashingSpans,
    ));
  }
  ...
  _i23.Staking kick({required List<_i25.MultiAddress> who}) {
    return _i23.Staking(_i24.Kick(who: who));
  }
  ...
  _i23.Staking setStakingConfigs({
    ...
    return _i23.Staking(_i24.SetStakingConfigs(
  ...
  _i23.Staking chillOther({required _i3.AccountId32 stash}) {
    return _i23.Staking(_i24.ChillOther(stash: stash));
  }

  /// Force a validator to have at least the minimum commission. This will not affect a
  /// validator who already has a commission greater than or equal to the minimum. Any account
  /// can call this.
  _i23.Staking forceApplyMinCommission(
      {required _i3.AccountId32 validatorStash}) {
    return _i23.Staking(
        _i24.ForceApplyMinCommission(validatorStash: validatorStash));
  }
  ...
  _i23.Staking setMinCommission({required _i4.Perbill new_}) {
    return _i23.Staking(_i24.SetMinCommission(new_: new_));
  }
  ...
  _i23.Staking payoutStakersByPage({
    required _i3.AccountId32 validatorStash,
    required int era,
    required int page,
  }) {
    return _i23.Staking(_i24.PayoutStakersByPage(
      validatorStash: validatorStash,
      era: era,
      page: page,
    ));
  ...
  _i23.Staking updatePayee({required _i3.AccountId32 controller}) {
    return _i23.Staking(_i24.UpdatePayee(controller: controller));
  }
  ...
  _i23.Staking deprecateControllerBatch(
      {required List<_i3.AccountId32> controllers}) {
    return _i23.Staking(
        _i24.DeprecateControllerBatch(controllers: controllers));
  }
