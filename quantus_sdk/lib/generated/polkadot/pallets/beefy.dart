...
import '../types/sp_consensus_beefy/fork_voting_proof.dart' as _i10;
import '../types/sp_consensus_beefy/future_block_voting_proof.dart' as _i11;
...
class Txs {
  ...
  /// reporter.
  _i6.Beefy reportDoubleVotingUnsigned({
    required _i7.DoubleVotingProof equivocationProof,
    required _i8.MembershipProof keyOwnerProof,
  }) {
    return _i6.Beefy(_i9.ReportDoubleVotingUnsigned(
      equivocationProof: equivocationProof,
      keyOwnerProof: keyOwnerProof,
    ));
  }
  ...
  _i6.Beefy setNewGenesis({required int delayInBlocks}) {
    return _i6.Beefy(_i9.SetNewGenesis(delayInBlocks: delayInBlocks));
  }

  /// Report fork voting equivocation. This method will verify the equivocation proof
  /// and validate the given key ownership proof against the extracted offender.
  /// If both are valid, the offence will be reported.
  _i6.Beefy reportForkVoting({
    required _i10.ForkVotingProof equivocationProof,
    required _i8.MembershipProof keyOwnerProof,
  }) {
    return _i6.Beefy(_i9.ReportForkVoting(
      equivocationProof: equivocationProof,
      keyOwnerProof: keyOwnerProof,
    ));
  }
  ...
  /// if the block author is defined it will be defined as the equivocation
  /// reporter.
  _i6.Beefy reportForkVotingUnsigned({
    required _i10.ForkVotingProof equivocationProof,
    required _i8.MembershipProof keyOwnerProof,
  }) {
    return _i6.Beefy(_i9.ReportForkVotingUnsigned(
      equivocationProof: equivocationProof,
      keyOwnerProof: keyOwnerProof,
    ));
  }
  ...
  /// and validate the given key ownership proof against the extracted offender.
  /// If both are valid, the offence will be reported.
  _i6.Beefy reportFutureBlockVoting({
    required _i11.FutureBlockVotingProof equivocationProof,
    required _i8.MembershipProof keyOwnerProof,
  }) {
    return _i6.Beefy(_i9.ReportFutureBlockVoting(
      equivocationProof: equivocationProof,
      keyOwnerProof: keyOwnerProof,
    ));
  }
  ...
  /// if the block author is defined it will be defined as the equivocation
  /// reporter.
  _i6.Beefy reportFutureBlockVotingUnsigned({
    required _i11.FutureBlockVotingProof equivocationProof,
    required _i8.MembershipProof keyOwnerProof,
  }) {
    return _i6.Beefy(_i9.ReportFutureBlockVotingUnsigned(
      equivocationProof: equivocationProof,
      keyOwnerProof: keyOwnerProof,
    ));
  }
