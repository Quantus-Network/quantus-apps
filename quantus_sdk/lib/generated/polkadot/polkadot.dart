...
import 'pallets/bounties.dart' as _i25;
import 'pallets/child_bounties.dart' as _i26;
import 'pallets/claims.dart' as _i21;
...
import 'pallets/delegated_staking.dart' as _i31;
import 'pallets/dmp.dart' as _i39;
import 'pallets/election_provider_multi_phase.dart' as _i27;
import 'pallets/fast_unstake.dart' as _i30;
...
import 'pallets/multisig.dart' as _i24;
import 'pallets/nomination_pools.dart' as _i29;
...
import 'pallets/proxy.dart' as _i23;
...
import 'pallets/vesting.dart' as _i22;
import 'pallets/voter_list.dart' as _i28;
...
class Queries {
  Queries(_i1.StateApi api)
      : system = _i2.Queries(api),
        ...
        claims = _i21.Queries(api),
        vesting = _i22.Queries(api),
        proxy = _i23.Queries(api),
        multisig = _i24.Queries(api),
        bounties = _i25.Queries(api),
        childBounties = _i26.Queries(api),
        electionProviderMultiPhase = _i27.Queries(api),
        voterList = _i28.Queries(api),
        nominationPools = _i29.Queries(api),
        fastUnstake = _i30.Queries(api),
        delegatedStaking = _i31.Queries(api),
  ...
  final _i21.Queries claims;

  final _i22.Queries vesting;

  final _i23.Queries proxy;

  final _i24.Queries multisig;

  final _i25.Queries bounties;

  final _i26.Queries childBounties;

  final _i27.Queries electionProviderMultiPhase;

  final _i28.Queries voterList;

  final _i29.Queries nominationPools;

  final _i30.Queries fastUnstake;

  final _i31.Queries delegatedStaking;
...
class Constants {
  ...
  final _i21.Constants claims = _i21.Constants();

  final _i22.Constants vesting = _i22.Constants();

  final _i57.Constants utility = _i57.Constants();

  final _i23.Constants proxy = _i23.Constants();

  final _i24.Constants multisig = _i24.Constants();

  final _i25.Constants bounties = _i25.Constants();

  final _i26.Constants childBounties = _i26.Constants();

  final _i27.Constants electionProviderMultiPhase = _i27.Constants();

  final _i28.Constants voterList = _i28.Constants();

  final _i29.Constants nominationPools = _i29.Constants();

  final _i30.Constants fastUnstake = _i30.Constants();

  final _i31.Constants delegatedStaking = _i31.Constants();
