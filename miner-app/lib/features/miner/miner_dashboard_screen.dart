  ...
  Future<void> _fetchWalletBalance() async {
    ...
    try {
      ...
      if (mnemonic != null) {
        ...
        final keypair = ServiceLocator().substrateService.dilithiumKeypairFromMnemonic(mnemonic);
        ...
        final balance = await ServiceLocator().substrateService.queryBalance(address);
