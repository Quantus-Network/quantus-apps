...
class MinerProcess {
  ...
  Future<void> start() async {
    ...
    final List<String> args = [
      ...
      '9616',
      '--bootnodes',
      '/ip4/37.60.245.15/tcp/30333/p2p/QmYM5KSbc5abpfhCGC2NKhqWhGiPcgtmrFyihz4nSKT3SA,',
      '/ip4/212.97.64.25/tcp/54543/p2p/QmPNFFXEQr6CKwnwFEvr3JtwrsBMgPHaGnYQ5SxNxr3vQX',
      '--name',
      'QuantusMinerGUI',
      '--external-miner-url',
